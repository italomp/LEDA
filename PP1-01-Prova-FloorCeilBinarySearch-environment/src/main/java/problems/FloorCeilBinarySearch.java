...
public class FloorCeilBinarySearch implements FloorCeil {
	 ...
	 */
	public Integer auxFloor(Integer[] array, int leftIndex, 
			int rightIndex, Integer x, Integer candidatoFloor) {
	 ...
	 */
	public Integer auxCeil(Integer[] array, int leftIndex, 
			int rightIndex, Integer x, Integer candidatoCeil) {
